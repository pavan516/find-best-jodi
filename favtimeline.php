...
<meta name="keywords" content="find best jodi,find best jodi timeline,find best jodi posts, find best jodi favourite timeline,findbestjodi favourite posts,findbestjodi following posts." /> 
...
<!-- End Of Links -->
	...
	<body>
		...
		<!-- Posting A Private Post -->
		<script>  
		function favinsert_posts()
		{
			$.ajax({
				url: "favinsert_posts.php",
				method: "POST",
				async: false,
				success: function(data)
				{
					$('.favinsert_posts').html(data);	
				}
			});
		}
		</script>
		<div class="favinsert_posts"></div>
		<!-- End Of Posting a Private Post -->
		...
		<div id="fh5co-main">
			<div class="container">
				<div class="row" >
					<table id="customers">
						<tr>
							<th><center><a href="javascript:void(0)" style="color:white;" onclick="favinsert_posts()">Share Your Feelings (Privately - Only to followers) <i class="fa fa-chevron-down"></i> </a></center></th>
						</tr>
					</table>
					<table id="customers">
						<tr>
							<th><center>Favourite Posts / Private Posts</center></th>
						</tr>
					</table>
