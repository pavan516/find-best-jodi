...
{
	$query = mysqli_query($mysqli,"SELECT * FROM users ORDER BY user_id DESC LIMIT ".$_POST["start"].", ".$_POST["limit"]."");
	while($row_user = mysqli_fetch_array($query))
	{
		...
		<div class="item fetched">
			...
			<div class="fh5co-desc">
				...
				<center><a class="btn btn-default" href="https://findbestjodi.com/user_profile.php?user=<?php echo $encoded_user_id; ?>" >View Profile</a>
