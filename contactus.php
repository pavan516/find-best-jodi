			...
			<div class="container">
				<div class="row">
					<div class="col-md-8 col-md-offset-2">
						<center><h3 style="color:grey;">Contact Us</h3></center>
							...
							<form method="post" action="" enctype="multipart/form-data">
								...
								<div class="row">
									...
									<div class="col-md-12">
										...
										<div class="form-group">
											<textarea name="msg" id="msg" required="required" class="form-control" placeholder="Message Us What's In Your Mind!"/></textarea>
										</div>
									</div>
									
									<div class="form-group">
										<center><input type="submit" name="contact" id="contact" class="btn btn-primary" value="Contact Us"></center>
									</div>
...
if(isset($_POST['contact']))
{
	...
	echo "<script>alert('Thank You For Contacting Us! - Very Soon Our Team Member Will Contact You!')</script>";
