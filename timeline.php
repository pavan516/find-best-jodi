	...
	<body>
		...
		function insert_posts()
		{
			$.ajax({
				...
				{
					$('.insert_posts').html(data);	
				}
			});
		}
		</script>
		<div class="insert_posts"></div>
		<!-- End Of Posting a public Post -->
		...
		<div id="fh5co-main">
			<div class="container">
				<div class="row" >
					<table id="customers">
						<tr>
							<th><center><a href="javascript:void(0)" style="color:white;" onclick="insert_posts()">Share Your Feelings Publicly <i class="fa fa-chevron-down"></i> </a></center></th>
						</tr>
					</table>
					<table id="customers">
						<tr>
							<th><center>Public Posts</center></th>
						</tr>
					</table>
